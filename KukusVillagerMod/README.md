...
3. Huts will NOT spawn in existing world. To see huts you need to start a new world. Sorry for that :( . You can control the number of huts generated by editing the config. <br>
...
6. Remember to delete old config :) <br>
